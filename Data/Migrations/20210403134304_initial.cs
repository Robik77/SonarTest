        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsEditableAnswers = table.Column<bool>(type: "bit", nullable: false),
                    CreatorForeignKey = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Forms", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Forms_AspNetUsers_CreatorForeignKey",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FormsPassedId = table.Column<int>(type: "int", nullable: false),
                    UsersId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FormUser", x => new { x.FormsPassedId, x.UsersId });
                    table.ForeignKey(
                        name: "FK_FormUser_AspNetUsers_UsersId",
                        column: x => x.UsersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FormUser_Forms_FormsPassedId",
                        column: x => x.FormsPassedId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Elements_Attributes_AttributeId",
                        column: x => x.AttributeId,
                        principalTable: "Attributes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Elements_Blocks_BlockId",
                        column: x => x.BlockId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Elements_AttributeId",
                table: "Elements",
                column: "AttributeId");

            migrationBuilder.CreateIndex(
                name: "IX_Elements_BlockId",
                table: "Elements",
                column: "BlockId");

            migrationBuilder.CreateIndex(
                name: "IX_Forms_CreatorForeignKey",
                table: "Forms",
                column: "CreatorForeignKey");

            migrationBuilder.CreateIndex(
                name: "IX_FormUser_UsersId",
                table: "FormUser",
                column: "UsersId");
